...
func TestEmptyBitset32(t *testing.T) {
	b := New32(0)
	if l := b.Len(); l != 0 {
...
func TestBitsetNew32(t *testing.T) {
	v := New32(16)
	if v.Test(0) != false {
...
func TestBitsetHuge32(t *testing.T) {
	v := New32(math.MaxUint32)
	if v.Test(0) != false {
...
func TestBitsetIsClear32(t *testing.T) {
	v := New32(1000)
